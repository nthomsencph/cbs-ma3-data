...
Written home assignment based on an assigned subject

An assigned subject consists of one or more questions you are expected to answer; such as for instance a case assignment. You will be assigned the questions when the exam starts. Then you will have a certain amount of time to complete the home assignment. This could be 24, 48 or 72 hours – or even longer.

The assignment can be either an individual assignment or a group assignment.

__

Written home assignment based on a subject you choose yourself

A subject you choose yourself means that you have to work out a research question yourself that falls within the learning objectives of the course.

The assignment can be individual or in groups. Often this type of assignment will be a project.

Read more about project assignments below.

## Prepare for your exam with CBS' exam archive

You can search for previously used exam assignment in [CBS' exam assignment archive.](https://exam-assignment-archive.cbs.dk/) Here it's easy to find previously used assignments and use these for your preparations for written exams.

You can search for the exam assignments, using your programme or course code, course title, exam code or exam title.

Use the exam assignment archive for exercise and inspiration in your preparation for written exam assignments and to get an impression of the type of questions you may be asked.

[CBS exam archive](https://exam-assignment-archive.cbs.dk/)
...
#### Follow the rules for good academic conduct
...
](https://sw.cbs.dk/ExamGuides/How%20to%20Save%20as%20PDF.pdf)

__

How to add student number and exam name to pdf file

](http://sw.cbs.dk/ExamGuides/Add%20information%20to%20a%20PDF.pdf)

__

How to merge two pdf-files

](http://sw.cbs.dk/ExamGuides/How%20to%20merge%20PDFs.pdf)

__

How to convert to PDF from PC or Mac

](https://support.microsoft.com/en-us/office/save-or-convert-to-pdf-or-xps-in-office-desktop-apps-d85416c5-7d77-4fd6-a216-6f4bf7c7c110#ID0EBBH=macOS)
...
You will find name and contact information on Digital Exam in the specific exam.
...
Some projects are followed by an oral exam.

Read more about [oral exams].
...
If the topic of the project is pre-determined, you will be assigned a topic or specific case you have to base your project on. Often you will still have to figure out a more specific research question yourself. This means that you choose which specific angle you take. Just make sure that you stay within the given topic when you do this.

Read more about [Research question].

#### Topic of your own choice

If you choose the topic for the project yourself, you have to formulate your own research question that falls within the academic field and learning objectives of the course. As it can take some time to arrive at a good research question, you should start thinking about possible topics already at the beginning of the course.

The research question will be the fundament of your project; therefore you need to make sure you have thought it through. It needs to have enough substance to warrant writing a whole project, and if you have made sure of that from the get go, you will avoid a lot of issues down the road.
...
#### Get a handle on your references

In large projects, it can be hard to keep track of all the sources and the bibliography.

Read more about [Bibliography and references].

It is your responsibility to make sure that you follow all the rules and guidelines for good academic conduct, so you will not be suspected of plagiarism.
...
You will typically tend to procrastinate when you are overwhelmed by your workload. So be realistic when you plan your time, so you will not end up wasting time by sorting your spice rack alphabetically.

It is a good idea to take stock of the situation when you start and finish your work for the day.

1.  **Before you start:** Get an overview of how far along you are in the process and which specific tasks you have today. Write it down so you can check if you do indeed get through what you have planned.
...
If the research question is too broad, you cannot use it to focus your work. You should therefore make sure that your research question is as delimited and specific as possible. A good, delimited research question often consists of one specific question or statement within the problem context, and perhaps with more detailed sub-questions.
...
You can start writing about your motivation for the topic, your prejudices, and what you think your study will show. You can also write about your ideas for empirical data, methodology, theories and the main concepts that you want to work with.

#### Find your research question(s)

By writing out your initial ideas for your project, you will automatically create a good foundation for your research question(s). This also makes it easier to discuss your project during your first supervisor meeting, and you can start searching for literature.

#### Your first writing is all about getting started

When you first start writing, don't use too much time creating perfect texts. What matters is that you write some text that you can continue to work with. You will undoubtedly have to change and rewrite the text several times as you learn more about your topic.

## Focus your literature search

You will probably find that there is an endless amount of literature about your topic, and that you will never be finished reading about it all. Therefore, it is important that you are aware of what you are reading and how it plays into your project and research question.

#### Organise your literature according to each part of your project

Some literature may be useful as background knowledge or for methodology, theory, or analysis. When you are clear about the purpose of your reading, you can avoid wasting unnecessary time on reading a lot of literature that is not directly relevant to your project.

## Write and read at the same time

The reading and writing processes should happen subsequently. By writing from the start of your project and while you read, your writing can guide your reading to be more focused.

#### Take notes with your writing in mind

When you write while you read, you should think about the purpose of your writing to avoid simply taking notes from your literature. Metacommunicate with yourself (and your writing partners) by writing what your text will be used for.

## Write on several parts of the project simultaneously

You can make your writing process easier if you work on all parts of the project at the same time.

Make a document for each section of the paper, e.g. introduction, method, theory, analysis and conclusion. Start by writing everything you can think of for each section.

#### On-going writing creates coherence

Write on all documents as you read. By keeping all sections of your project open for further writing and alterations, you are able to benefit in the following ways:

-   you can write new important points directly into the relevant sections when these come to mind or emerge in your on-going reading for other sections.

-   it is easier to keep writing on written ideas and notes rather than keeping a blank document for each section.

-   you create coherence between the different parts of your project as you go back and forth.
...
CBS' antiplagiarism guide

](https://libguides.cbs.dk/c.php?g=684990&fbclid=IwAR2uz6SuDsCjzBb9qo1xyFZrW7mdF-QV4e_PWmTntdMemSXCrJTELXYXKlY)

## Remember to write down your sources!

Put down your sources next to your writing from the start, so you do not forget where you found your pearls of wisdom. It would be a shame if you had written down a really good point without a source, which you would be forced to leave out, because it would be considered plagiarism.

Learn more about how to avoid plagiarism and how to handle your references:

## If you are at a standstill

If you get stuck in your writing and find it difficult to move on, do something else instead of what you are doing right now.

#### Loosen up your writer's block:

-   **Close the computer:** Try kick-starting your thoughts by taking a walk or a run, getting a cup of coffee, or something else to energise you and inspire you.

-   **Talk to someone:** This could be a friend, fellow student or family member.

-   **Write freely:** If it is difficult to get on with it, it can help just writing about your thoughts, frustrations, or why you are at a standstill without thinking or editing yourself.

-   **Brainstorm on paper or a board:** It will start new thoughts and can help you get a better overview

-   **Use your supervisor:** If you are at a standstill, don't be afraid to speak with your supervisor about it. Your supervisor is your most important sparring partner, and it is one of their most important tasks to help you along in this process.
...
Readability and reader comprehension are key elements to a good project. By letting other people give you feedback on your project, you will be able to spot ambiguities, incoherences and poor argumentation.
...
You should always revise your texts after writing them. You can do ongoing revision as you work or wait until you have written the whole paper. No matter how you choose to revise, this is an important step to ensure that your writing and the quality of your paper is on point.

#### Sloppiness can outweigh your argumentation

When you re-read your previous writings, you will typically spot repetitions, irrelevant or redundant parts, errors and ambiguities. A reader will quickly spot these, as they will lose comprehension, and it will reduce their trust in your argumentation.

#### Proofreading takes time

It takes longer than you would expect to revise and proofread a project. You should make sure to set aside enough time – preferably a week for a large project. You can also ask someone else to check your paper for errors.
...
If you do not use MS Word

If you use another programme for writing than MS Word, here's a list of alternative reference management programmes.

#### Overleaf / LaTex

-   [Mendeley works well in Overleaf](https://www.overleaf.com/learn/how-to/How_to_link_Mendeley_to_your_Overleaf_account)
...
](https://libguides.cbs.dk/APA7th)

## Read more...

__

CBS guide to academic integrity

](https://libguides.cbs.dk/c.php?g=684990&p=4892991)

__

Find the next Mendeley course

__

Stopplagiarism guide

](http://stopplagiat.nu/en/)

# Appendices and transcription
...
The purpose of appendices is to make relevant material available for the examiner and other readers. Appendices for assignments should be included as they are a part of the research the academic arguments in the assignment are based on.

If you use the material in your appendices to support a claim or statement, you must remember to include it and refer to the relevant appendix. If you fail to do so, it can be compared to a missing reference to the literature i.e. an error that can negatively affect the assessment.

You examiner must be able to read and understand the academic argumentation and progression in your paper without reading the appendices. If your examiner has to look in the appendices in order to understand how you have come to a result, conclusion or from A to B, it is a deficiency in your paper, which can negatively affect the assessment.

Therefore, you should not use appendices to include important argumentation or explanations, just because there was not room for it in the paper itself.

## The function of appendices

The function of appendices is:

-   to make relevant material available for the examiner and other readers
-   to ensure good academic conduct
-   to create transparency in the academic process
-   to make it possible for the examiner and other readers to check the academic craftsmanship

## Quality, form and scope

The quality, form or scope of the appendices does not affect the quality of the actual paper or the assessment.

However, the way you handle the material from your appendices and sources does, because it shows your ability to collect and apply relevant sources in your research and/or problem solving.

## Typical appendices

Typical types of appendices could be:

-   interviews
-   questionnaires
-   results from questionnaires
-   Internal data from companies
-   Tender documents
-   Strategy papers
-   Reports

## Appendices and assessment
...
#### Enclose interview as an appendix

Nevertheless, it is acknowledged academic conduct to document that the empirical data exists, and its content is applied correctly in the analysis. Therefore, it is customary to enclose interviews as appendices. It provides the reader with the opportunity to see the broader context of the interview from which the quotes are cited. It is a matter of taste whether one prefers to read a print version or listen to an audio file. You should always ask your supervisor what he/she prefers.



#### Transcription

It is also important how the interviews are used in your research. Some types of analyses e.g. discourse analysis and hermeneutic interpretation are very text-oriented. Here, it is not enough to know what is said during the interview. It is just as important to know how it is said, what is concealed, and how a statement corresponds with the rest of the interview. To reveal this, you have to make a complete transcription of the interview.

When you apply coding, you make it easier for yourself to see the broader perspective if you transcribe the interviews completely.
...
For instance, you have to obtain a written consent from people you wish to interview. A signed consent form ensures that the persons involved are informed of your use of the personal data and that they agree to have their data used for your specific purpose.

You may not collect, process or disclose personal data until you have a signed consent form from the involved participants and you must submit a copy of the consent form to every participant who has signed it.

You can find a [template for a consent form here](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20Bilag%20B%20-%20Samtykkeblanket%20UK.pdf) and read more about personal data and GDPR when writing assignments on the page [Personal data and GDPR].

#### Anonymisation and pseudonymisation

You can always choose to anonymise or pseudonymise the personal data, you collect for your assignment.

If personal data is anonymised, the person, to whom the personal data relates, can no longer be identified. In this case, the personal data will no longer be characterised as “personal data” within the meaning of the GDPR, after which the data protection rules do not apply.

If it is not entirely possible to anonymise personal data, you can also choose to pseudonymise the personal data by replacing the personal data with a pseudonym or a code. Even though pseudonymised personal data cannot directly lead to the identification of a specific person without the use of additional information, the GDPR rules do still apply. If you choose to pseudonymise personal data, you must ensure that the additional information, that can be used to “unlock” the pseudonymisation, is stored separately and is governed by technical and organisational measures to ensure that the personal data cannot be traced back to an identifiable person.

You can read more about how to stay compliant with the rules of the GDPR when writing assignments on [Personal data and GDPR].
...
If you gain access to or if you collect personal data in connection with your master thesis or any given assignment, you are responsible for taking care of the data and must not do anything that could damage the data subject.
...
Personal data can be categorized as four different types:
...
-   information regarding adoption, grades and exam cheating
...
Personal data must be communicated via secure e-mail and there must be obtained a valid consent before processing sensitive personal data.

The following information is sensitive data:
...
Information about criminal offences is considered general personal data under the GDPR. An information about criminal offences may be information that a person has committed a particular offence but it may also be e.g. information about a person serving a prison sentence.
...
Whether an information can be considered confidential relies on an assessment of whether the information should, in the general view of society, be requested to be kept secret to the public. Non-sensitive personal information may be confidential in some situations, but confidential information will not always be sensitive. However, sensitive personal data will always be confidential.

Confidential information may e.g. be information regarding
...
If you collect personal data from e.g. test subjects or via a questionnaire to be used in an assignment, you are responsible for the collected data, which means that you are responsible for:
...
If you collect data on other people, you need their written consent to use and possibly disclose the information you receive. To obtain written consent, you must ask everyone involved to sign a consent form. A signed consent form ensures that the persons involved are informed of your use of the personal data and that they agree to have their data used for your specific purpose.

You may not collect, process or disclose personal data until you have a signed consent form from the involved participants and you must submit a copy of the consent form to every participant who has signed it.

Use [Consent to the processing of personal data](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20bilag%20B%20-%20Samtykkeblanket%20UK.pdf?csf=1&web=1&e=2XwWaX)

__

Complying with the rights of the data subjects

The data subjects have a number of rights in relation to the processing of their data. The most important rights of the data subjects are:
...
-   The right to restriction of processing – the data subject has the right to limit the processing of his/her personal data, while it is clarified whether the data subject's personal data needs to be corrected
-   The right to be forgotten – the data subject is entitled to have his/her personal data deleted if the data subject withdraws his/her consent to the processing
...
Once you have collected data and filled in relevant forms, you must keep this information in a safe and secure manner. This can be done by for example using Microsoft OneDrive, which is available to all students at CBS.

You must ensure that the equipment used to collect data with is protected by password to avoid access by unauthorized persons. You must also ensure that data is not accidentally or unlawfully destroyed, lost or impaired.

You must always delete personal data when it is no longer relevant for your assignment. This means in practice, that you must delete the personal data when your assignment has been assessed and the deadline for complaints has expired.

Read more about One Drive at [Office 365]
...
Once you have created the record, it must be stored electronically in OneDrive. You may need it in case the Danish Data Protection Agency inspects CBS to check whether we comply with the GDPR.

Use [Record of processing activities](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20Bilag%20C%20-%20Behandlingsfortegnelse%20UK.pdf)
...
If you need to collect data from e.g. municipalities, hospitals or companies, you must also comply with the personal data rules.

You can access data if you have a valid consent from the data subjects.

[Consent to the processing of data](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20bilag%20B%20-%20Samtykkeblanket%20UK.pdf?csf=1&web=1&e=0kdsx0)

## The use of research data in master theses and assignments
...
[Disclosure of personal research data to students](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20Bilag%20E%20-%20Blanket%20til%20videregivelse%20af%20forskningsdata%20UK.pdf)
...
If your collaboration should include assignments where you process personal data in the research project by following instructions from the researcher, you must also enter into a data processing agreement. You can find a template for a data processing agreement here:

[Data processing agreement in connection with a research project](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20Bilag%20G%20-%20Data%20processing%20agreement%20in%20connection%20with%20a%20research%20project.pdf)

## If you are associated with a research project
...
If you are provided with personal data that you are responsible for storing, you must store the data in a safely manner.
...
[Collaboration and confidentiality agreement in connection with a research project](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20Bilag%20H%20-%20Samarbejds-%20og%20fortrolighedsaftale%20UK.pdf)

## If you are associated with a research project as a student assistant

If you are employed as a student assistant at CBS, and you, in connection with your job, are associated with a research project, you are obliged to process personal data confidentially. This means that you cannot disclose personal data to others or store data on your computer when you no longer are associated with the research project.

As a student assistant, you must comply with "CBS' information security policy."

[CBS' information security policy (in Danish)](/:b:/r/sites/CoursesAndExams/Delte%20dokumenter/Opgaver%20+%20projekter/Handling%20personal%20data%20CBS%20informationssikkerhedsregler%20only%20in%20DK.pdf?csf=1&web=1&e=MiIusx)
...
It is important to meet the submission deadline. Should something unexpected happen causing you to miss the deadline, different rules apply, according to the type of exam.

#### Written sit-in exams in the CBS Examination Halls

If for technical reasons e.g. IT problems you submit your exam paper late, it will automatically be sent for assessment. You do not have to request assessment or dispensation. This rule applies to all programmes.

#### Master thesis defence

Find more information on [Submit your thesis].

#### Written home assignments and projects

If your exam paper is not submitted before the deadline, you must send a request for an exemption to your exam administrator to have your paper assessed. Otherwise, you risk that your assignment won't be graded and that you receive the grade -03 and you use an exam attempt.
...
## Submission through Digital Exam

All exam papers must be submitted on [Digital Exam](https://eksamen.cbs.dk/)

All papers must be submitted as PDF, unless stated otherwise.

See [how to convert files into PDF](https://sw.cbs.dk/ExamGuides/How%20to%20merge%20PDFs.pdf).

All papers without an appertaining oral exam handed in through Digital Exam are anonymised.

## Declaration of authorship

When submitting a written paper, you must sign it to declare that formal requirements are met and that you have not committed plagiarism. You can read more about plagiarism under [Exam cheating.]

You sign the declaration of authorship on Digital Exam by checking the field **\[Yes\]** next to **\[Declaration of Authorship\]** in step 2 before submitting your paper. Here you can read about what exactly your signature means.
...
Read more about [Confidentiality and cooperation with companies]

## Audio files

You can submit audio files on Digital Exam or you can transcribe them and submit them as appendices. You should always agree with your lecturer/supervisor how audio files are submitted.

Read more about [Appendices and transcription]
...
It must be stated both in the table of contents and in the introductions of each part of the paper who is responsible for that part.
...
[Formal requirements for bachelor's project]
...
-   method section
-   indications of [individualisation of group papers]
-   footnotes and endnotes
-   conclusion and perspective

Pages that count in the total number of pages but not in the total number of characters:
